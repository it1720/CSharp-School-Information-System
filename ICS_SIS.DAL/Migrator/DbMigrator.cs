...
public class DbMigrator(IDbContextFactory<SISDbContext> dbContextFactory, DALOptions options)
    : IDbMigrator
{
    ...
    {
        await using SISDbContext dbContext = await dbContextFactory.CreateDbContextAsync(cancellationToken);
